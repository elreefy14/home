                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        ...
                        Positioned(
                          bottom: 20
                              .h, // Adjust this value to add padding from the bottom
                          left: 20
                              .w, // Adjust this value to add padding from the left
                          child: Column(
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      color: Colors
                                          .white, // Changed from Color(0xFF848484) to white
                                      fontSize: 12.sp,
                                      fontFamily: 'Monadi',
                                      fontWeight: FontWeight.w400,
                                    ),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: SvgPicture.asset(
                                    'assets/vectors/IC_Bookmark.svg'),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          CircleAvatar(
                            backgroundImage: AssetImage(house.ownerImageUrl),
                          ),
                          SizedBox(width: 10.w),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  LightThemeColors.blueOcean.withOpacity(0.6),
                              borderRadius: BorderRadius.circular(5),
                            ),
                            child: Row(
